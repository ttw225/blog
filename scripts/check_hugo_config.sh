...
PARAMS="$ROOT_DIR/config/_default/params.toml"
assert_match '^mainSections\s*=\s*\[\s*"posts"\s*\]' "$PARAMS" \
  "params.toml mainSections must be [\"posts\"] for single-posts archive."
